...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/requests-ratelimiter-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13811&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/requests-ratelimiter-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `requests-ratelimiter` can be installed with:

```
conda install requests-ratelimiter
```

It is possible to list all of the versions of `requests-ratelimiter` available on your platform with:
